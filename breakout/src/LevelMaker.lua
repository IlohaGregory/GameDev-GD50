...
function LevelMaker.createMap(level)
    ...
    -- making sure only one key brick is spawned pair level
    local keyBrickGen = false
    ...
    for y = 1, numRows do
        ...
        for x = 1, numCols do
            -- probability of drawing the key brick
            local keyBrick = math.random(1, math.floor(2 / level))
            ...
            -- if keybrick is present in this iteration
            if keyBrick == 2 and keyBrickGen == false then
                b.color = 6
                b.tier = 3
                b.keyBrick_on = true
                keyBrickGen = true
