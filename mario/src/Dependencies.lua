...
gTextures = {
    ...
    ['flagAndPoles'] = love.graphics.newImage('graphics/flags.png')
}
...
gFrames = {
    ...
    ['flagAndPoles'] = GenerateFlags(gTextures['flagAndPoles'], TILE_SIZE, TILE_SIZE),
    ['poles'] = GeneratePoles(gTextures['flagAndPoles'], TILE_SIZE, 48)
}
