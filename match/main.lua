...
function love.load()
    ...
    love.keyboard.mousecord = {}
end

function love.mousemoved(x, y)
    love.keyboard.mousecord['x'], love.keyboard.mousecord['y'] = push:toGame(x, y)
end

function love.mousepressed(x, y, button)
    if button == 2 then
        love.keyboard.mousecord['active'] = true
    end
    if button == 1 then
        love.keyboard.mousecord['enter'] = true
    end
end
...
function love.update(dt)
    ...
    love.keyboard.keysPressed = {}
    love.keyboard.mousecord['enter'] = nil
end
